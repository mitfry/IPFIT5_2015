...
class WorkerThread(threading.Thread):
    ...
    def run(self):
        ...
        print 'Process list complete! (1/4)\n'
        ...
        print 'Service list complete! (2/4)\n'
        ...
        print 'Software list complete! (3/4)\n'

        # Generating a list of found cloud services on the target pc using the cloud function
        from Cloud import cloud_search as cl

        cl()
        print 'Cloud services list complete! (4/4)\n'
